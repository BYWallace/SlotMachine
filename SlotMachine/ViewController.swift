...
//  SlotMachine
//
//  Created by Brett Wallace on 3/5/15.
...
class ViewController: UIViewController {
    ...
    func setUpSecondContainer(containerView: UIView) {
        ...
        for var containerNumber = 0; containerNumber < kNumberOfContainers; containerNumber++ {
            for var slotNumber = 0; slotNumber < kNumberOfContainers; slotNumber++ {
                var slot:Slot
    ...
    func setUpThirdContainer(containerView: UIView) {
        ...
        self.betTitleLabel.center = CGPoint(x: containerView.frame.width * 3 * kSixth, y: containerView.frame.height * kThird * 2)
